...
export const WORLD_COUNTRIES: WorldCountry[] = [
  ...
  { code: 'UM', name: 'ABD Küçük Dış Adaları' },
...
export function getWorldCountryName(code: string | null | undefined): string | undefined {
  if (!code) return undefined;
  return WORLD_COUNTRIES.find((c) => c.code === code.toUpperCase())?.name;
}
